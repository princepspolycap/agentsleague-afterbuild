...
| Reliability and Safety | 20% | Human verification gate, simulation fallback, synthetic demo data, deterministic validation tools. |
| Creativity and Originality | 15% | Side-scrolling business dungeon instead of a chat UI or literal fantasy-only RPG. |
